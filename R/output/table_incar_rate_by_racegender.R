...
read_csv(here("data/NLSY97_clean.csv")) %>%
  ...
  pivot_wider(names_from = race, values_from = length_of_incareration) %>%
  ...
  kbl(
    caption = "Total Number of Months that the individual was incarcerated for in 2002 by Race and Gender",
    booktabs = TRUE,
    format = "latex",
